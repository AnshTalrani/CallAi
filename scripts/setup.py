#!/usr/bin/env python3
"""
Setup script for Voice Chat Agent with Ollama
"""
...
def create_env_file():
    ...
    print("🔧 Setting up Voice Chat Agent with Ollama")
    print("=" * 50)
    
    # Get Ollama server configuration
    print("\n🌐 Ollama Server Configuration:")
    api_base = get_user_input(
        "Enter your Ollama API base URL", 
        "http://localhost:11434"
    )
    
    api_key = get_user_input(
        "Enter your Ollama API key (usually not required)", 
        "not-needed"
    )
